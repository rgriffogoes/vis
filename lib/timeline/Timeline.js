...
Timeline.prototype.getEventProperties = function (event) {
  ...
  var mainItemData = item? item.getCurrentData() : null; // if overlapped
  ...
  return {
    ...
    mainItemId: mainItemData ? mainItemData.id : null,
    mainItemStart: mainItemData ? mainItemData.start : null,
