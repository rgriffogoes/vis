...
RangeItem.prototype.repositionX = function(limitSize) {
  ...
  var boxWidth = Math.max(end - start + 0.5, 2);
 ...
 * @Override
 */
RangeItem.prototype.collisionOverlap = function() {
  if (!this.dom) return NaN;
  var overlapThreshold = Math.floor(this.width);
  return overlapThreshold==0? this.width:overlapThreshold;
};
